...
| 状态码 | 说明 | schema |
| -------- | -------- | ----- |
|200|OK|Result  List   UserAddress|
...
| 状态码 | 说明 | schema |
| -------- | -------- | ----- |
|200|OK|Result  PageInfo   UserBrowseHistoryVo|
...
|code|业务状态码|integer(int32)|integer(int32)|
|message|响应消息|string||
|data||PageInfo   UserBrowseHistoryVo|PageInfo   UserBrowseHistoryVo|
|&emsp;&emsp;total||integer(int64)||
